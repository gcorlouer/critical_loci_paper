...
Let $\Sigma_{XY} \in \mathrm{Mat}_{d_0,\; d_L}$ and $U_Q \in \mathrm{Mat}_{d_L,\; d_L - r}$. Define the algebraic variety:
\[
\Gamma_d^r
:=
\left\{
...
\[
\Gamma_{d,XY}:= \Sigma_r\cap\Gamma_d^r
\]
\end{definition}
\begin{comment}
...
\end{comment}
\begin{proposition}
From \cite{achour2024loss} proof of proposition 10, appendix B.5 (gradient formulas), we can write the set of rank $r$ critical points of a DLN as the following algebraic variety:
\begin{equation*}
...
\end{equation*} 
In other words, $\mathcal{C}_r \subset \Omega$ denote the set of rank-$r$ first-order critical points in a normal form of the DLN, i.e.\ the set described by the existence of residual blocks $Z = (Z_1, \dots, Z_L)$ such that
\[
...
\]
This suggests that $\mathcal{C}_r $ is some fiber bundle over $\Gamma_{d,XY}$, and that a stratification of $\Gamma_{d,XY}$ can be lifted to $\mathcal{C}_r$.
\end{proposition}
%------------------------------------------------------------
