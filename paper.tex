...
\begin{enumerate}
    ...
    \[
        \bar\Phi \colon G \times_{H_r} \mathcal{Z} \longrightarrow \Omega_r,
        \qquad
        \bar\Phi([g, Z]) = \Phi(g, Z).
    \]
    ...
    \[
        ...
        Z \in \mathcal{Z}
        \;\big|\;
        \{\, g\in G \mid g\cdot \iota(Z)\in S_r \,\}
        =
        H_r
        \bigr\}.
    \]
    ...
    \[
        ...
        G\cdot \iota(Z)\cap S_r
        =
        H_r\cdot \iota(Z).
    \]

    Let $\Omega_r^{\circ} := \Phi(G \times \mathcal{Z}^{\circ})$.
    Then the restriction
    \[
        \bar\Phi \colon
        G \times_{H_r} \mathcal{Z}^{\circ}
        \xrightarrow{\;\sim\;}
        \Omega_r^{\circ}
    \]
    is a bijection. In particular, on the principal locus,
    \begin{equation}\tag{8}
        \Omega_r^{\circ}
        \;\cong\;
        G \times_{H_r} \mathcal{Z}^{\circ}.
...
\begin{proof}[Proof of Proposition~\ref{prop:associated-bundle}]
We prove the three statements in order.

\medskip
\noindent
\textbf{(1) Image of $\Phi$.}

For any $(g,Z)\in G\times\mathcal Z$ we have by definition
\[
\Phi(g,Z)=g\cdot\iota(Z)\in G\cdot S_r=\Omega_r,
\]
so $\Phi(G\times\mathcal Z)\subseteq\Omega_r$.

Conversely, if $W\in\Omega_r$, then by definition there exist
$g\in G$ and $Z\in\mathcal Z$ such that
$W=g\cdot\iota(Z)$.
Hence $W=\Phi(g,Z)$ and therefore
$\Phi(G\times\mathcal Z)=\Omega_r$.

\medskip
\noindent
\textbf{(2) $H_r$-invariance.}

Let $h\in H_r$. Using the definition of the action~(5),
\[
\Phi((g,Z)\cdot h)
=
\Phi(gh,h^{-1}\cdot Z)
...
Since $h\in H_r$ stabilizes the slice $S_r=\iota(\mathcal Z)$,
one has
\[
...
\Phi(g,Z),
\]
so $\Phi$ is $H_r$–invariant and hence descends to a map
\[
\bar\Phi:G\times_{H_r}\mathcal Z\to\Omega_r.
\]

Surjectivity follows from part (1).

\medskip
\noindent
\textbf{(3) Injectivity on the principal locus.}

Let $Z\in\mathcal Z^\circ$.
Assume that
\[
\bar\Phi([g,Z])=\bar\Phi([g',Z']).
\]
By definition of $\bar\Phi$ this means
\[
g\cdot\iota(Z)=g'\cdot\iota(Z').
\]

Setting $h=g^{-1}g'\in G$, we obtain
\[
\iota(Z)=h\cdot\iota(Z').
\]
In particular $h\cdot\iota(Z')\in S_r$.

Since $Z'\in\mathcal Z^\circ$, by definition of the principal locus
\[
\{\,g\in G\mid g\cdot\iota(Z')\in S_r\,\}=H_r.
\]
Therefore $h\in H_r$.
...
(g',Z')=(gh,h^{-1}\cdot Z),
\]
which means that $(g',Z')$ lies in the $H_r$–orbit of $(g,Z)$
under the action~(5).
Thus
\[
[g',Z']=[g,Z]
\]
in $G\times_{H_r}\mathcal Z^\circ$.

This proves injectivity of $\bar\Phi$ on $G\times_{H_r}\mathcal Z^\circ$.

\medskip

Surjectivity onto $\Omega_r^\circ$ follows directly from the definition
$\Omega_r^\circ=\Phi(G\times\mathcal Z^\circ)$.
Hence the restriction
\[
\bar\Phi:G\times_{H_r}\mathcal Z^\circ\to\Omega_r^\circ
\]
is bijective.
\end{proof}
