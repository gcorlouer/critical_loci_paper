...
Equivalently, for all pairs \((i,j)\) with \(\delta(i,j)\le L - 1\),
\[
...
\begin{proposition}[Codimension of $\Gamma_{d,\sigma}$ via the largest cyclic orbit]
\label{prop:codim-GammaXY-largest-orbit}
Let $\Gamma_{d,\sigma}$ be stratified by cyclic rank patterns as in Proposition~12.10:
\[
\Gamma_{XY}
\;=\;
...
\begin{proof}\label{app:proof_cyclic_inversion}
